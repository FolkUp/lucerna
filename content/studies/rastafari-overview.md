...
|----------|-------|---------|
| [History: From Garvey to Globalization]({{< relref "rastafari-history" >}}) | UNIA, Selassie, Howell, Pinnacle, Shashamane | 45+ |
| [Ideology and Symbolism]({{< relref "rastafari-ideology" >}}) | Babylon/Zion, dreads, colors, Lion, ital, Dread Talk | 30+ |

### Direction 2: Culture and Music

| Material | Topic | Sources |
|----------|-------|---------|
| [Music: Ska → Rocksteady → Reggae → World]({{< relref "rastafari-music" >}}) | Musical evolution, Marley, The Wailers, Burning Spear | 30+ |
| [Cannabis in Rastafari]({{< relref "rastafari-cannabis" >}}) | Sacred and legal aspects, menshen and ganja, harm reduction | 25+ |

### Direction 3: Sociology and Law

| Material | Topic | Sources |
|----------|-------|---------|
| [Rastafari in Russia]({{< relref "rastafari-russia" >}}) | Jah Division, post-Soviet context, subculture vs. religion | 15+ |
| [Gender, Law and Discrimination]({{< relref "rastafari-gender-law" >}}) | Patriarchy, womanism, CROWN Act, dreads in court | 25+ |

### Direction 4: Meta-analysis

| Material | Topic | Sources |
|----------|-------|---------|
| [Source Audit: Levikova (2015)]({{< relref "rastafari-source-audit" >}}) | Quality of source base, overlooked works, methodological issues | 24 (audited) |
...
**1. Garvey rejected Rastafari.** Marcus Garvey condemned Selassie as a hypocrite and coward — yet his "prophecy" became the foundation of the movement. Details: [History]({{< relref "rastafari-history" >}}).

**2. Selassie rejected deification.** He was an Orthodox Christian and never publicly denounced Rastafari — but neither did he accept their worship. Details: [History]({{< relref "rastafari-history" >}}).

**3. The Ethiopian Church criticizes Rastafari.** Despite common origins (Kebra Negast, Solomonic dynasty), the church considers the Rastafarian reading of Ethiopian tradition heretical. Details: [Ideology]({{< relref "rastafari-ideology" >}}).

**4. Shashamane — "promised land" of disappointment.** 200 hectares granted by Selassie (1950) were nationalized in 1975. Of 2000+, fewer than 300 remain. Details: [History]({{< relref "rastafari-history" >}}).

**5. Academic unclassifiability.** No consensus — religion? subculture? social movement? Rastafarians themselves reject the term "religion". Details: [Gender, Law and Discrimination]({{< relref "rastafari-gender-law" >}}).

## Gaps in Levikova's Article

Detailed analysis available in [Source Audit]({{< relref "rastafari-source-audit" >}}). Main issues:
