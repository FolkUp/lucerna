...
The series **"Scatology in Culture"** is an interdisciplinary OSINT investigation into the role of excrement and bodily waste in global culture, art, philosophy, economics, and science. The research was conducted as part of the FolkUp Research Lab (Lucerna).
...
### Direction 1: Thought and Language

| Material | Topic | Sources |
|----------|-------|---------|
| [Philosophy: From Diogenes to Postmodernism]({{< relref "scatology-philosophy" >}}) | Cynics, Freud, Bataille, Kristeva, Žižek, Laporta | 25+ |
| [Linguistics: Taboo Etymology]({{< relref "scatology-linguistics" >}}) | Proto-Slavic *govьno, PIE *skeyd-, Tabuation, Euphemisms | 30+ |

### Direction 2: Art and Literature

| Material | Topic | Sources |
|----------|-------|---------|
| [Art: From Manzoni to Pavlenskiy]({{< relref "scatology-art" >}}) | Merda d'artista, Ofili, Delvoye, Viennese and Moscow Actionism | 25+ |
| [Literature: From Rabelais to Sorokin]({{< relref "scatology-literature" >}}) | Swift, Sade, Joyce, Kharms, Kundera, Bukowski | 25+ |

### Direction 3: Power and Money

| Material | Topic | Sources |
|----------|-------|---------|
| [Economics: From Guano to FMT Startups]({{< relref "scatology-economics" >}}) | Guano Wars, Ambergris, Kopi Luwak, Coprolites, Biotech | 25+ |
| [Politics: Feces as Protest Weapon]({{< relref "scatology-political" >}}) | Diogenes, Luther, Actionism, Biological Weapons, Sanitation and Power | 30+ |

### Direction 4: Body and Myth

| Material | Topic | Sources |
|----------|-------|---------|
| [Medicine: Microbiome and the FMT Revolution]({{< relref "scatology-medical" >}}) | Fecal Microbiota Transplantation, Coprology, Bristol Stool Scale, Microbiome | 30+ |
| [Mythology: Sacred Excrement]({{< relref "scatology-mythology" >}}) | Sterquilinus, Scarabaeus, Kavaya-no-kami, Bonnacon, Feast of Fools | 25+ |

## 10 Functions of Scatology in Culture

The research identified ten stable functions that scatology performs in global culture:
...
The series employs a system of markers:
