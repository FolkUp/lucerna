...
pii_reviewed: true
summary: "Analysis of EU AI Act implementation in Portugal: national AI strategy, ANACOM's role as market surveillance authority, CNPD enforcement, tax incentives (SIFIDE II), and practical recommendations for developers and startups."
---

# EU AI Act: Implementation in Portugal

**Research Date:** February 25, 2026
**Scope:** National implementation of EU AI Act in Portugal
**Audience:** Developers, digital publishers, startups in Portugal
...
1. **Amália** — national multimodal language model (LLM) for European Portuguese. Investment €5.5 million from Recovery and Resilience Plan (PRR). Base version completed October 2025. Final release expected **June 2026**.

2. **AI Factory** — Portugal's participation in European "AI factories" network to increase computational capacity.

3. **Experimental sandboxes** for safe testing of AI solutions in public sector.

4. **"IA nas PME" line** — support programme for AI implementation by SMEs (up to €300,000, up to 75% coverage).
...
1. **Transposition of PLD II** (Directive (EU) 2024/2853) — deadline December 9, 2026
2. **National law on AI Act penalties** — in development
3. **Labor Code amendments** — announced by government after May 2025 elections
4. **DSA digital services coordinator appointment** — in process
...
1. **AI Literacy (since February 2, 2025):** As user (deployer) of AI tools, you are already obliged to ensure understanding of risks and limitations of AI systems used.

2. **Prohibited Practices (since February 2, 2025):** Ensure your AI use does not fall under Article 5 prohibitions (manipulative systems, social scoring, real-time biometric identification, etc.).

3. **GDPR / Lei 58/2019:** When processing personal data through AI services:
...
1. **Copyright:** AI-generated content **not protected** by copyright in Portugal. Content where human used AI as tool **may be protected** if meets originality criterion.

2. **AI Content Labeling (from August 2, 2026):** Synthetic content (text, images, audio, video) must be labeled in machine-readable format.

3. **TDM Exception:** Check rights holders' opt-out before using data for commercial purposes.

4. **Open source exception (EU AI Act):** Applies only to GPAI model providers released under free licenses. For projects **using** AI (not being models), exception does not apply directly.

### 8.3 When Creating a Company

1. **Recommended Form:** Sociedade Unipessoal por Quotas (Lda) — for access to SIFIDE II and limited liability.

2. **R&D Incentives:** Apply for SIFIDE II for R&D expenses in AI (up to 82.5% return). Deadline — end of 5th month of following year.

3. **"IA nas PME" Program:** Up to €300,000 non-repayable funding for AI implementation.

4. **Regulatory sandbox:** Monitor creation of ZLT and regulatory sandboxes under AI Act (deadline — August 2026).
