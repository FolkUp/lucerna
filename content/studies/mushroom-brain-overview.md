...
pii_reviewed: true
sensitive: true
summary: "Series overview of 10 OSINT investigations on mushrooms and the brain: from neuropharmacology to cultural myths. 27K+ words, 230+ sources."
---
...
|----------|-------|---------|
| [Lion's Mane]({{< ref "mushroom-brain-lions-mane" >}}) | Hericium erinaceus: NGF, erinacines, cognitive effects | 20+ |
| [Psilocybin]({{< ref "mushroom-brain-psilocybin" >}}) | Neuropharmacology, depression, addiction, therapy | 60+ |
| [Microdosing]({{< ref "mushroom-brain-microdosing" >}}) | Protocols, placebo effect, Fadiman, Stamets Stack | 50+ |

### Direction 2: Ethnobotany and Toxicology

| Material | Topic | Sources |
|----------|-------|---------|
| [Amanita muscaria]({{< ref "mushroom-brain-amanita" >}}) | Toxicology, ethnography, contemporary trends | 15+ |
| [Castaneda and Ethnobotany]({{< ref "mushroom-brain-castaneda" >}}) | Psychedelic anthropology, ethnobotany | 20+ |
| [Safety]({{< ref "mushroom-brain-safety" >}}) | Poisoning, interactions, legal status, harm reduction | 25+ |

### Direction 3: Industry and Myths

| Material | Topic | Sources |
|----------|-------|---------|
| [Industry and Biohacking]({{< ref "mushroom-brain-biohacking" >}}) | Four Sigmatic, DSHEA, corporate wellness, market | 15+ |
| [Myths]({{< ref "mushroom-brain-myths" >}}) | "Lenin is a Mushroom" (Kuryokhin), Stoned Ape, Soma, Eleusinian Mysteries | 18+ |
| [Source Audit]({{< ref "mushroom-brain-source-audit" >}}) | Verification of claims, conflicts of interest, red flags | 18+ |
