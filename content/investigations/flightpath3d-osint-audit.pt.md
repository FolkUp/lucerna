...
> **Sumário INV-2026-0313-FP3D.** A FlightPath3D (entidade legal: Betria Interactive LLC) é uma empresa legítima de IFE fundada em 2012, implementada em mais de 5.000 aeronaves. Líder de mercado em mapas interactivos de movimento. Avaliação geral: **empresa legítima com marketing inflacionado, opacidade estrutural e riscos geopolíticos não resolvidos.** Apenas 6,7% da base de clientes alegada foi verificada de forma independente. Subsidiária portuguesa = entidade-casca de capital mínimo. Ligação à Rússia (BIN64/Girgidov) não abordada. Zero escândalos/queixas encontrados. Risco de disrupção por IA: MÉDIO-BAIXO.
>
> *Painel de investigação: CyberGonzo (auditoria OSINT), 4 agentes de pesquisa (2 lotes × 2)*
...
- Taxa de verificação baixa para alegações de clientes (6,7%)
- Zero transparência sobre liderança, finanças, número de funcionários
...
## Tópicos Adiados (Sessão 2)

Os seguintes tópicos requerem investigação mais profunda se necessário:
- Análise profunda de liderança: verificações de background individual sobre Veksler, Jackson, Girgidov
- Saúde financeira: tendências de receitas, rentabilidade, indicadores de fluxo de caixa
- Portfólio patentes/PI: patentes registadas, propriedade PI entre entidades EUA/PT/RU
- Rastreio formal de sanções através de bases de dados de compliance (não apenas pesquisa web)
- Estado operacional BIN64: análise profunda de registo russo, número actual de funcionários
- Presença em conferências: APEX EXPO, AIX Hamburgo — presença real vs apenas comunicado

---

## Metodologia

Esta investigação foi conduzida usando exclusivamente fontes abertas (OSINT):

1. **Pesquisa multi-agente** — 4 agentes especializados de pesquisa em 2 lotes (verificação website/alegações, análise base clientes, panorama competitivo/indústria, liderança/incidentes)
2. **Triangulação de fontes** — ~40 fontes web referenciadas cruzadas
3. **Verificação de registos corporativos** — Secretário de Estado Califórnia, Racius português, registos empresariais russos

**Fontes:** websites públicos, arquivos imprensa especializada, registos empresariais, bases de dados indústria, motores de busca
**Limitações:** sem acesso a registos financeiros (LLC), sem rastreio formal de sanções, sem entrevistas insider

*Investigação conduzida: 13.03.2026*
*4 agentes de pesquisa, 2 lotes, ~40 fontes web consultadas*
*Próxima revisão: mediante pedido*
