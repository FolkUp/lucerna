...
Мы планируем использовать **Umami** — ориентированную на конфиденциальность аналитическую платформу на собственном сервере. При активации Umami:
...
**Текущий статус:** Аналитика ещё не активирована. Этот раздел будет обновлён при включении аналитики.
